          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <ol className="text-sm text-slate-700 list-decimal list-inside space-y-1 mb-2">
                <li><strong>Resend (Recommended - Easiest):</strong> Sign up at <a href="https://resend.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">resend.com</a> and get your API key</li>
                ...
                <li>Add <code className="bg-slate-200 px-1 rounded">RESEND_API_KEY</code> with your API key value (starts with <code className="bg-slate-200 px-1 rounded">re_</code>)</li>
                <li>Redeploy your Convex functions: <code className="bg-slate-200 px-1 rounded">npx convex deploy</code></li>
              </ol>
              <p className="text-xs text-slate-500 mt-2">
                <strong>Alternative:</strong> You can also use SMTP2GO, Mailgun, or SendGrid. See README for details.
              </p>
